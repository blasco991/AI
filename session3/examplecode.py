...
print("Choose from a spceific distribution: ", np.random.choice(5, p=[0.1, 0.2, 0.5, 0.1, 0.1]))

# List of successors from state 36 (start) indexed by action number: (prob, succ_state, reward, terminal)
print("Successors from state 36 indexed by action number: ", env.P[36])
...
print("Element wise division (skip divisions by 0):\n", a)
