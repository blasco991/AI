...
path = "../viz/public/artifacts/ts"
for folder in ["dot", "md", "png"]:
    pathlib.Path(path + "/" + folder).mkdir(parents=True, exist_ok=True)

# envs = ["XSMaze-v0", "SmallMaze-v0", "GrdMaze-v0", "CompMaze-v0", "BigMaze-v0"]  # "BlockedMaze-v0",
# envs = ["SmallMaze-v0", "GrdMaze-v0"]  # , "BlockedMaze-v0"]
envs = ["XSMaze-v0"]

# "ids": search.tree_search,
algs = {"dfs": search.tree_search, "bfs": search.tree_search, "ucs": search.tree_search,
