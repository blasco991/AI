...
"0_0.1.2.5.8.8.11-3" [label=11 style=filled color=black peripheries=2 fillcolor="0.62941176 0.97940977 0.63171101 1.        "];  "0_0.1.2.5.8.8-0" -> "0_0.1.2.5.8.8.11-3" [label="(D,1)" ]; 
 "#exp 30, #gen 117, cost:5" [ shape=box ];
}```
