...
"0_3.2.1.0.4.5.9.8.12.16.17.18-1" [label=18 style=filled color=white  fillcolor="0.52745098 0.99907048 0.69169844 1.        "];  "0_3.2.1.0.4.5.9.8.12.16.17-1" -> "0_3.2.1.0.4.5.9.8.12.16.17.18-1" [label="(R,1)" ]; 
 "#exp 28, #gen 33, cost:10" [ shape=box ];
}```
